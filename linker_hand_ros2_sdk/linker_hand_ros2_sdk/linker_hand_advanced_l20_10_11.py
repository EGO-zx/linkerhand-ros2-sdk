...
class LinkerHandAdvancedG20(Node):
    ...
    def _check_linker_hand_type(self):
        if self.modbus != "None":
            ...
            sys.exit(0)
        if self.hand_joint.upper() != "L20-10" and self.hand_joint.upper() != "L20-11":
    ...
    def _init_hand(self):
        ...
        # L20-10和L20-11电机实时电流。由于电机顺序不同，这两个型号独有
...
def main(args=None):
    ...
    try:
        ...
        node = LinkerHandAdvancedG20(name="linker_hand_advanced_l20_10_11",hand_type=args.hand_type,can=args.can,is_touch=args.is_touch)
