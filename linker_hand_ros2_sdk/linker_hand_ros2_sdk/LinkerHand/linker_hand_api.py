...
class LinkerHandApi:
    def __init__(self, hand_type="left", hand_joint="L10", modbus = "None",can="can0"):  # Ubuntu:can0   win:PCAN_USBBUS1
        ...
        if self.hand_joint == "G20" or self.hand_joint =="L20-10" or self.hand_joint =="L20-11":
            if modbus != "None":
    ...
    def finger_move(self, pose=None):
        ...
        if (self.hand_joint.upper() == "O6" or self.hand_joint.upper() == "L6") and len(pose) == 6:
            ...
            self.hand.set_joint_positions(pose)
        elif (self.hand_joint == "G20" or self.hand_joint == "L20-10" or self.hand_joint == "L20-11") and len(pose) == 20:
            self.hand.set_joint_positions(pose)
    ...
    def get_joint_speed(self):
        ...
        if self.hand_joint.upper() == "O6" or self.hand_joint.upper() == "L6":
            ...
            return speed
        elif self.hand_joint == "G20" or self.hand_joint == "L20-10" or self.hand_joint == "L20-11":
            return self.hand.get_speed()
